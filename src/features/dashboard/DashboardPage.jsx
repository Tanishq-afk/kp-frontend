...
import { PAYMENT_METHOD_LABELS } from '../../config/constants.js';

const PIE_COLORS = ['#6d28d9', '#ec4899', '#0ea5e9', '#16a34a', '#f59e0b', '#64748b'];
  ...
  return (
    <Box>
      ...
      <Grid container spacing={2} sx={{ mb: 1 }}>
        ...
        <Grid item xs={12} sm={6} md={3}>
          <StatCard label="Items sold" value={formatNumber(totals.itemsSold)} icon={<ShoppingBagRoundedIcon />} color="secondary" />
        </Grid>
        <Grid item xs={12} sm={6} md={3}>
